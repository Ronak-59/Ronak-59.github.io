...
bannerImage.addEventListener('change', function() {
    ...
    fReader.onload = function() {
        ...
        document.getElementById('image1').style.backgroundImage = fReader.result;
        // Save it when data complet
...
function readImage() {
    if ( this.files && this.files[0] ) {
        ...
        FR.onload = function(e) {
             el("tableBanner").src = e.target.result;
             t= e.target.result.substring(23);
             $(".loaded").show();
             $(".preloader").show();
...
app.models.predict("bd367be194cf45149e75f01d59f77ba7", t).then(
    function(response) {
        ...
        var options = [
        set0 = [response.outputs[0].data.concepts[0].name,response.outputs[0].data.concepts[1].name,response.outputs[0].data.concepts[2].name, response.outputs[0].data.concepts[3].name ,response.outputs[0].data.concepts[4].name,response.outputs[0].data.concepts[5].name,response.outputs[0].data.concepts[6].name,response.outputs[0].data.concepts[7].name,response.outputs[0].data.concepts[8].name,response.outputs[0].data.concepts[9].name],
        set1 = [response.outputs[0].data.concepts[0].value,response.outputs[0].data.concepts[1].value,response.outputs[0].data.concepts[2].value, response.outputs[0].data.concepts[3].value ,response.outputs[0].data.concepts[4].value,response.outputs[0].data.concepts[5].value,response.outputs[0].data.concepts[6].value,response.outputs[0].data.concepts[7].value,response.outputs[0].data.concepts[8].value,response.outputs[0].data.concepts[9].value]
    ];
    ...
    for(var i = 0; i < array.length; i++) {
        ...
        // Set its contents:
        item.appendChild(document.createTextNode(array[i]+" ● "+array2[i]));
...
//var stuff = response.outputs[0].data.concepts[0].name;
var stuff = options[0].toString().replace(/,/g , ", ");
console.log(stuff);
document.getElementById('foo').appendChild(makeUL(options[0],options[1]));
   document.getElementById('image1').scrollIntoView();
       ...
       $.ajax({
         ...
         method:"POST",
         headers : {"Content-Type":"application/x-www-form-urlencoded", "x-app-id": "6e0fb95f", "x-app-key": "9b1ac4be1d3f471a783e2974c585813f", "x-remote-user-id": "0" },
         data:{"query":stuff}, contentType:"application/x-www-form-urlencoded; charset=utf-8", dataType:"json",
 success: function(res){
    console.log("food data : "+res);
   console.log(res.foods[1].food_name+" ● Calories: "+res.foods[0].nf_calories+" ● "+res.foods[0].serving_qty+" ● "+res.foods[0].serving_weight_grams);

   var options2 = [
        set0 = [res.foods[0].food_name, res.foods[1].food_name,res.foods[2].food_name,res.foods[3].food_name,res.foods[4].food_name,res.foods[5].food_name,res.foods[6].food_name,res.foods[7].food_name],
        set1 = [res.foods[0].nf_calories, res.foods[1].nf_calories,res.foods[2].nf_calories,res.foods[3].nf_calories,res.foods[4].nf_calories,res.foods[5].nf_calories,res.foods[6].nf_calories,res.foods[7].nf_calories],
        set2 = [res.foods[0].serving_qty, res.foods[1].serving_qty,res.foods[2].serving_qty,res.foods[3].serving_qty,res.foods[4].serving_qty,res.foods[5].serving_qty,res.foods[6].serving_qty,res.foods[7].serving_qty],
        set3 = [res.foods[0].serving_weight_grams, res.foods[1].serving_weight_grams,res.foods[2].serving_weight_grams,res.foods[3].serving_weight_grams,res.foods[4].serving_weight_grams,res.foods[5].serving_weight_grams,res.foods[6].serving_weight_grams,res.foods[7].serving_weight_grams],
        set4 = [res.foods[0].nf_protein, res.foods[1].nf_protein,res.foods[2].nf_protein,res.foods[3].nf_protein,res.foods[4].nf_protein,res.foods[5].nf_protein,res.foods[6].nf_protein,res.foods[7].nf_protein],
        set5 = [res.foods[0].nf_cholesterol, res.foods[1].nf_cholesterol,res.foods[2].nf_cholesterol,res.foods[3].nf_cholesterol,res.foods[4].nf_cholesterol,res.foods[5].nf_cholesterol,res.foods[6].nf_cholesterol,res.foods[7].nf_cholesterol],
        set6 = [res.foods[0].nf_sugars, res.foods[1].nf_sugars,res.foods[2].nf_sugars,res.foods[3].nf_sugars,res.foods[4].nf_sugars,res.foods[5].nf_sugars,res.foods[6].nf_sugars,res.foods[7].nf_sugars],
        set7 = [res.foods[0].nf_total_carbohydrate, res.foods[1].nf_total_carbohydrate,res.foods[2].nf_total_carbohydrate,res.foods[3].nf_total_carbohydrate,res.foods[4].nf_total_carbohydrate,res.foods[5].nf_total_carbohydrate,res.foods[6].nf_total_carbohydrate,res.foods[7].nf_total_carbohydrate],
        set8 = [res.foods[0].nf_total_fat, res.foods[1].nf_total_fat,res.foods[2].nf_total_fat,res.foods[3].nf_total_fat,res.foods[4].nf_total_fat,res.foods[5].nf_total_fat,res.foods[6].nf_total_fat,res.foods[7].nf_total_fat],
        set9 = [res.foods[0].nf_sodium, res.foods[1].nf_sodium,res.foods[2].nf_sodium,res.foods[3].nf_sodium,res.foods[4].nf_sodium,res.foods[5].nf_sodium,res.foods[6].nf_sodium,res.foods[7].nf_sodium],
        set10 = [res.foods[0].nf_potassium, res.foods[1].nf_potassium,res.foods[2].nf_potassium,res.foods[3].nf_potassium,res.foods[4].nf_potassium,res.foods[5].nf_potassium,res.foods[6].nf_potassium,res.foods[7].nf_potassium]
    ];

       function makeUL2(array3,array4,array5,array6,array7,array8,array9,array10,array11,array12,array13) {
    // Create the list element:
    var list = document.createElement('ul');
    ...
    for(var i = 0; i < array3.length; i++) {
        ...
        // Set its contents:
        item.appendChild(document.createTextNode(array3[i]+" ● Serve_Qty: "+array5[i]+" ● Grams: "+array6[i]));
       
        item.appendChild(document.createElement('hr'));
       // $('.single_pakeg_text ul li').css('background', 'url(' + res.foods[0].photo.thumb + ') no-repeat left center');
        item.appendChild(document.createElement("br"));
        item.appendChild(document.createTextNode("Calories: "+array4[i]+" ● Proteins: "+array7[i]+" ● Cholesterol: "+array8[i]));
        item.appendChild(document.createElement("br"));


        item.appendChild(document.createTextNode("Sugars: "+array9[i]+" ● Carbohydrates: "+array10[i]+" ● Fats: "+array11[i]));
        item.appendChild(document.createElement("br"));

        item.appendChild(document.createTextNode("Sodium: "+array12[i]+" ● Potassium: "+array13[i]));
        // Add it to the list:
        list.appendChild(item);
    //     item.firstChild.setAttribute('style', 'text-align: -webkit-center');
     //   item.firstChild.setAttribute('style', 'font-weight: bold');
        list.appendChild(document.createElement('hr'));
 ...
 function tableCreate(array3,array4,array5,array6,array7,array8,array9,array10,array11,array12,array13) {
        //body reference 
      //  var body = document.getElementBy("body")[0];
  ...
  //  for(var k = 0; k < options2[0].length; k++) {
       var xxyyzz = document.getElementById('foo2');
     //   xxyyzz.appendChild(document.createTextNode(res.foods[k].name));
xxyyzz.setAttribute("text-align", "-webkit-center");
xxyyzz.appendChild(makeUL2(options2[0],options2[1],options2[2],options2[3],options2[4],options2[5],options2[6],options2[7],options2[8],options2[9],options2[10]));
xxyyzz.appendChild(document.createElement('hr'));
//}
        ...
        $.ajax({
         ...
         method:"GET",
         headers : {"Content-Type":"application/json", "user-key": "c92ce5735aa68ba495ab8d104d7816d0"},
         data:{"q":response.outputs[0].data.concepts[0].name}, contentType:"application/json", dataType:"json",
 success: function(res){
    console.log(res);
    console.log("Restaurant 1 : "+ res.restaurants[0].restaurant.name);
    var options3 = [
        set0 = [res.restaurants[0].restaurant.name,res.restaurants[1].restaurant.name,res.restaurants[2].restaurant.name,res.restaurants[4].restaurant.name,res.restaurants[5].restaurant.name],
        set1 = [res.restaurants[0].restaurant.location.address,res.restaurants[1].restaurant.location.address,res.restaurants[2].restaurant.location.address,res.restaurants[4].restaurant.location.address,res.restaurants[5].restaurant.location.address],
        set2 = [res.restaurants[0].restaurant.url,res.restaurants[1].restaurant.url,res.restaurants[2].restaurant.url,res.restaurants[4].restaurant.url,res.restaurants[5].restaurant.url]     
             ];

              function makeUL3(array14,array15,array16) {
    // Create the list element:
    ...
    for(var i = 0; i < array14.length; i++) {
        ...
        // Set its contents:
        anchor.appendChild(document.createTextNode("Restaurant Name : "+array14[i]));
        anchor.appendChild(document.createElement('hr'));
        anchor.appendChild(document.createTextNode("Location : "+array15[i]));
        anchor.setAttribute('href',array16[i]);
        item.appendChild(anchor);
        // Add it to the list:
        list3.appendChild(item);

        list3.appendChild(document.createElement('hr'));
    }

    // Finally, return the constructed list:
    return list3;
}
  document.getElementById('foo3').appendChild(makeUL3(options3[0],options3[1],options3[2]));
...
el("selectedFile").addEventListener("change", readImage, false);
...
},{"../helpers/settle":18,"./../helpers/btoa":11,"./../helpers/buildURL":12,"./../helpers/cookies":14,"./../helpers/isURLSameOrigin":16,"./../helpers/parseHeaders":17,"./../helpers/transformData":20,"./../utils":21,"_process":43}],6:[function(require,module,exports){
'use strict';
...
},{"./core/InterceptorManager":7,"./core/dispatchRequest":8,"./defaults":9,"./helpers/bind":10,"./helpers/combineURLs":13,"./helpers/isAbsoluteURL":15,"./helpers/spread":19,"./helpers/transformData":20,"./utils":21}],7:[function(require,module,exports){
'use strict';
...
},{"../adapters/http":5,"../adapters/xhr":5,"_process":43}],9:[function(require,module,exports){
'use strict';
...
},{"./Concepts":24,"./Inputs":26,"./Models":28,"./Workflow":29,"./constants":30,"./helpers":31,"_process":43,"axios":4,"promise":35}],23:[function(require,module,exports){
"use strict";
...
},{"./Concepts":24,"./Model":27,"./constants":30,"./helpers":31,"./utils":33,"axios":4,"promise":35}],29:[function(require,module,exports){
'use strict';
...
},{"./../package.json":34,"./constants":30,"./helpers":31,"promise":35}],34:[function(require,module,exports){
module.exports={
  "_args": [
    [
      "clarifai",
      "/home/ronak/Documents/food-andrestorent-one-page-template/assets/js"
    ]
  ],
  ...
  "_shrinkwrap": null,
  "_spec": "clarifai",
  "_where": "/home/ronak/Documents/food-andrestorent-one-page-template/assets/js",
  "author": {
    "name": "Clarifai Inc."
  },
  "bugs": {
...
},{"asap/raw":3}],37:[function(require,module,exports){
'use strict';
...
},{"./core.js":36,"./done.js":37,"./es6-extensions.js":38,"./finally.js":39,"./node-extensions.js":41,"./synchronous.js":42}],41:[function(require,module,exports){
'use strict';
...
},{"./core.js":36,"asap":2}],42:[function(require,module,exports){
'use strict';
